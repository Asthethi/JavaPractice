...
public class DaysBetween {
    ...
    private static int FindDays(int day_date1, int month_date1, int year_date1, int day_date2,
                                int month_date2,
        ...
        startDateRemainingDays = Year.of(year_date1).isLeap() ? startDateRemainingDays + 1
                                                              : startDateRemainingDays;
